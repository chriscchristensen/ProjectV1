...
import com.example.android.tabbedactivity.databinding.FragmentAssessmentBinding
...
class MyItemRecyclerViewAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(
            FragmentAssessmentBinding.inflate(
    ...
    inner class ViewHolder(binding: FragmentAssessmentBinding) :
